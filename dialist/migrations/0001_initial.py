    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cert_no', models.BigIntegerField(unique=True, serialize=False, primary_key=True, default=0)),
                ('carat', models.FloatField(default=0)),
                ('color', models.IntegerField(choices=[(30, 'D'), (29, 'E'), (28, 'F'), (27, 'G'), (26, 'H'), (25, 'I'), (24, 'J'), (23, 'K'), (22, 'L'), (21, 'M'), (20, 'N'), (19, 'O'), (18, 'P'), (17, 'Q'), (16, 'R'), (15, 'S'), (14, 'T'), (13, 'U'), (12, 'V'), (11, 'W'), (10, 'X'), (9, 'Y'), (8, 'Z')], default=0)),
                ('clarity', models.IntegerField(choices=[(20, 'FL'), (19, 'IF'), (18, 'VVS1'), (17, 'VVS2'), (16, 'VS1'), (15, 'VS2'), (14, 'SI1'), (13, 'SI2'), (12, 'SI3'), (11, 'I1'), (10, 'I2'), (9, 'I3')], default=0)),
